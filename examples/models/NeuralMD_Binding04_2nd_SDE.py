...
class NeuralMD_Binding04(nn.Module):
    def __init__(self, args):
        super(NeuralMD_Binding04, self).__init__()
        ...
        self.gamma = torch.nn.Parameter(torch.tensor(
            # [[100., 100., 100.] for _ in range(args.ligand_num)]
            [[10., 10., 10.] for _ in range(args.ligand_num)]
            # [[0.1, 0.1, 0.1] for _ in range(args.ligand_num)]
        ))
        ...
        # self.sigma_projection = nn.Linear(self.emb_dim, 3)
    ...
    def forward(self, t, input_data, condition):
        ...
        white_noise = torch.randn_like(ligand_vec)
